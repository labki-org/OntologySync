 ...
 *
 * Tables managed:
 * - ontologysync_bundles: Installed bundle metadata
 * - ontologysync_modules: Installed module metadata
 * - ontologysync_pages: Imported page tracking with content hashes
 */
class SchemaHooks {
